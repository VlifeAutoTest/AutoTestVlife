...
class TestLinkObject(object):
    ...
    def __init__(self):
        ...
        self.url = myglobal.testlink_config.getValue('TESTLINK', 'url')
        self.key = myglobal.testlink_config.getValue('TESTLINK', 'key')
    ...
    def get_plan_id(self, product_name, plan_name):
        ...
        pld = ''
        pid = tobj.tlc.getProjectIDByName(product_name)
...
if __name__ == '__main__':
    ...
    tobj.tlc.reportTCResult('1400', pld, 'test', 'f', 'first try', testcaseexternalid='188', platformname="0")
