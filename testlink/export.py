...
def format_custom_fields(custom_obj, dom):
    ...
    return c_product, c_vendor, c_module, c_component
...
def parseXmlToCsv(infile,outfile):
    ...
    with open(outfile,"wb+") as wfile:
        ...
        for tc in testcases:
            ...
            c_product, c_vendor, c_module, c_component = format_custom_fields(custom_fields, dom)

            line = [c_product,c_vendor,exe_type_text,importance_text,c_module,c_component,case_name,summary_text,\
                    preconditions_text,steps_text,expe_result_text]
